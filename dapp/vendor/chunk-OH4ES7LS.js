...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-NPABGG77.js");
  const signature_ = (() => {
...
var sha2564 = /* @__PURE__ */ createHasher(() => new SHA2562());
...
function weierstrassPoints(opts) {
  ...
  class Point {
     ...
     */
    static fromHex(hex) {
      const P = Point.fromAffine(fromBytes4(ensureBytes("pointHex", hex)));
      P.assertValidity();
      return P;
    }
